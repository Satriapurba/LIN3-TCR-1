...
❂͜͡☆➣ [Jam say:「Name」]
❂͜͡☆➣ [Up]
❂͜͡☆➣ [Tagall/Miss you/Cipok]
❂͜͡☆➣ [Mebot]
❂͜͡☆➣ [Com on]
❂͜͡☆➣ [Com set]
❂͜͡☆➣ [Pesan add set: 「Isi Pesan」]
❂͜͡☆➣ [Pesan add cek「isi pesan」]
...
❂͜͡☆➣ [Cancel]
❂͜͡☆➣ [Cancel1]
❂͜͡☆➣ [B Cancel/Cancel say「Bot Cancel」
...
#-----------------------------------------------
            ...
            elif msg.text in ["Link off","Close"]:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
